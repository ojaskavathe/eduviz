...
import { SetSw } from "./SwitchUtil.js";
...
const solarSystem = document.getElementById('sc_solarSystem');
...
projection.onclick = function () {
  ...
  switchDefs("Methane", 0, "Methane is a one-carbon compound in which the carbon is attached by single bonds to four hydrogen atoms. It is a colourless, odourless, non-toxic but flammable gas (b.p. -161℃). It has a role as a fossil fuel, a member of greenhouse gas and a bacterial metabolite.");
  switchDefs("Ethane", 1, "Ethane, a colourless, odourless, gaseous hydrocarbon (compound of hydrogen and carbon), belonging to the paraffin series; its chemical formula is C2H6. Ethane is structurally the simplest hydrocarbon that contains a single carbon-carbon bond.");
